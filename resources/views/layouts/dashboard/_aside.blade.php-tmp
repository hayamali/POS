   ...
   <ul class="sidebar-menu" data-widget="tree">
        ...
        @if(auth()->user()->hasPermission('read_users'))
           <li>
            ...
            <a href="{{route('dashboard.users.index')}}"><i class="fa fa-th"></i><span>{{trans('site.users')}}</span></a>

           </li>
           @endif
@if(auth()->user()->hasPermission('read_categories'))
                <li><a href="{{route('dashboard.categories.index')}}"><i class="fa fa-th"></i><span>{{trans('site.categories')}}</span></a></li>

@endif
@if(auth()->user()->hasPermission('read_products'))
                <li><a href="{{route('dashboard.products.index')}}"><i class="fa fa-th"></i><span>{{trans('site.products')}}</span></a></li>

@endif
@if(auth()->user()->hasPermission('read_clients'))
                <li><a href="{{route('dashboard.clients.index')}}"><i class="fa fa-th"></i><span>{{trans('site.clients')}}</span></a></li>
